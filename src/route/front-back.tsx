...
const FrontPage: React.FC = () => {
    ...
    return (
        <Layout style={{ height: "98vh" }}>
            <Header color={pageConfig.headerColor} style={{ display: 'flex', alignItems: 'center', width: '100%', backgroundColor: pageConfig.headerColor, color: pageConfig.headerColor}} hasSider>
                
                   

                        <Title level={3} color='#ffffff'>{pageConfig.companyName}</Title>
                        <BankTwoTone href={""} />
                        <Dropdown
